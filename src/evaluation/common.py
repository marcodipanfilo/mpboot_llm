...
class EvaluationRunConfig:
    ...
    def obda_file(self) -> Path:
        return self.output_dir / "mappings__r2rml.obda"

    @property
    def rodi_patch_file(self) -> Path:
        return self.output_dir / "mappings__r2rml_rodi_patch.ttl"

    @property
    def ontop_properties_file(self) -> Path:
        return self.output_dir / "config__ontop_db.properties"

    @property
    def eval_rodi_report_file(self) -> Path:
        return self.output_dir / "eval_rodi__report.txt"

    @property
    def eval_rodi_tabular_file(self) -> Path:
        return self.output_dir / "eval_rodi__tabular.txt"

    @property
    def eval_ontop_metrics_file(self) -> Path:
        return self.output_dir / "eval_ontop__metrics.json"

    @property
    def eval_ontop_summary_file(self) -> Path:
        return self.output_dir / "eval_ontop__summary.txt"

    @property
    def eval_ontop_tabular_file(self) -> Path:
        return self.output_dir / "eval_ontop__tabular.txt"

    @property
    def comparison_diff_file(self) -> Path:
        return self.output_dir / "eval_compare__tabular.diff"
