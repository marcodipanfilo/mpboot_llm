...
Reads  : src2/memory/patterns_final.json
         ...
         src2/outputs/mappings/SE_mappings.json      (Phase 1, for owner resolution)
         src2/outputs/mappings/SH_mappings.json      (Phase 2, for owner resolution)
Writes : src2/outputs/mappings_process_sew.json      (LLM cache, resumable)
         src2/outputs/mappings/SEw_mappings.json     (final structured mapping)
"""
